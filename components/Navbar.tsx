...
const Navbar = () => {
  ...
  return (
    <div className="w-full shadow-navbarShadow h-20 lg:h-[12vh] sticky top-0 z-50 bg-bodyColor px-4 xl:px-10">
      <div className="max-w-container h-full mx-auto py-1 font-titleFont flex items-center justify-between">
        ...
        <div className="hidden mdl:inline-flex items-center gap-7">
          ...
          <a href="/assets/CV_PHAN_NGOC_TRUYEN.pdf" target="_blank">
            <motion.button
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{ delay: 0.5 }}
              className="px-2 py-2 rounded-md text-Green text-[13px] border border-textGreen hover:bg-hoverColor duration-300"
            >
              Resume
            </motion.button>
          </a>
        ...
        {showMenu && (
          ...
          >
            ...
            >
              ...
              <div className="flex flex-col items-center gap-7">
                ...
                <a href="/assets/CV_PHAN_NGOC_TRUYEN.pdf" target="_blank">
                  <motion.button
                    ...
                    className="w-32 h-10 rounded-md text-Green text-[13px] border border-textGreen hover:bg-hoverColor duration-300"
                  >
                    Resume
                  </motion.button>
                </a>
                <div className="flex gap-4">
                  <motion.a
                    ...
                    href="https://github.com/truyenpn22"
                    target="_blank"
                  >
                  ...
                  <motion.a
                    ...
                    href="https://www.facebook.com/truyen.pn"
                    target="_blank"
                  >
                    <span className="w-10 h-10 bg-bodyColor border-[1px] border-zinc-700 hover:text-textGreen text-zinc-200 rounded-full inline-flex items-center justify-center cursor-pointer hover:-translate-y-2 transition-all duration-300">
                  ...
                  <motion.a
                    ...
                    animate={{ y: 0, opacity: 1 }}
                    transition={{ delay: 1, ease: "easeIn" }}
                    href="https://www.instagram.com/__p.trye.22"
                    target="_blank"
                  >
                    <span className="w-10 h-10 bg-bodyColor border-[1px] border-zinc-700 hover:text-textGreen text-zinc-200 rounded-full inline-flex items-center justify-center cursor-pointer hover:-translate-y-2 transition-all duration-300">
              ...
              >
                <p className="text-sm w-72 tracking-wide text-textGreen text-center mt-4">
                  mymail@developer.me
                </p>
              </motion.a>
            </motion.div>
